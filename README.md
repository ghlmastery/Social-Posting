...
Automates four things for a GoHighLevel / business-consulting / coaching content
operation:
...
2. **Daily content ideas** — generated from your own
   ...
   plus real, current client themes (see #4), deduped against everything
   generated before.
...
4. **Fathom call insights** — syncs recent coaching/sales call summaries from
   Fathom, and has Claude extract anonymized recurring themes (client
   questions, objections, what they're building) — never names or company
   specifics — that then ground the daily content ideas in what clients are
...
npm run job:call-insights    # sync Fathom call themes (run before job:ideas)
...
src/
  ...
  lib/                   thin clients: Google Drive/Docs, YouTube Data API,
                          GHL Social Planner, Fathom, Anthropic
